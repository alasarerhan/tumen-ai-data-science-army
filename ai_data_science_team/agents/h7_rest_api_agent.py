...
tool layer (``ai_data_science_team.tools.h7_rest_api``) with
LangChain ``@tool`` decorators and exposes the standard
``make_h7_rest_api_agent`` factory + ``H7Agent`` OO
...
from ai_data_science_team.tools.h7_rest_api import (
    RESTConnector,
...
H7_TOOLS = [
    h7_build_rest_connector_wrapped,
]
...
class H7Agent(BaseAgent):
    ...
    def _make_compiled_graph(self):
        self.response = None
        return make_h7_rest_api_agent(**self._params)
