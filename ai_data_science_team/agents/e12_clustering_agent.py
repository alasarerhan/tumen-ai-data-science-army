...
tool layer (``ai_data_science_team.tools.e12_clustering``) with
LangChain ``@tool`` decorators and exposes the standard
``make_e12_clustering_agent`` factory + ``E12Agent`` OO
...
from ai_data_science_team.tools.e12_clustering import (
    ClusteringResult,
    build_naming_seeds,
    cluster_sizes,
...
AGENT_NAME = "e12_clustering_agent"
...
E12_TOOLS = [
    e12_run_kmeans_wrapped,
    e12_run_dbscan_wrapped,
    e12_run_hierarchical_wrapped,
    e12_compute_silhouette_wrapped,
    e12_compute_calinski_harabasz_wrapped,
    e12_cluster_sizes_wrapped,
    e12_profile_clusters_wrapped,
    e12_build_naming_seeds_wrapped,
    e12_segmentation_template_wrapped,
    e12_run_clustering_wrapped,
...
class E12Agent(BaseAgent):
    ...
    def _make_compiled_graph(self):
        self.response = None
        return make_e12_clustering_agent(**self._params)
