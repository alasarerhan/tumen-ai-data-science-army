...
tool layer (``ai_data_science_team.tools.f4_model_card``) with
LangChain ``@tool`` decorators and exposes the standard
``make_f4_model_card_agent`` factory + ``F4Agent`` OO
...
from ai_data_science_team.tools.f4_model_card import (
    CardSection,
    ModelCard,
    generate_card,
    get_card,
...
F4_TOOLS = [
    f4_generate_card_wrapped,
    f4_update_section_wrapped,
    f4_render_html_wrapped,
    f4_render_pdf_wrapped,
    f4_get_card_wrapped,
    f4_list_cards_wrapped,
]
...
class F4Agent(BaseAgent):
    ...
    def _make_compiled_graph(self):
        self.response = None
        return make_f4_model_card_agent(**self._params)
