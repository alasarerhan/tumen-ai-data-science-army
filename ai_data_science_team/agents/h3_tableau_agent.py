...
tool layer (``ai_data_science_team.tools.h3_tableau``) with
LangChain ``@tool`` decorators and exposes the standard
``make_h3_tableau_agent`` factory + ``H3Agent`` OO
...
from ai_data_science_team.tools.h3_tableau import (
    TableauConnector,
...
H3_TOOLS = [
    h3_build_tableau_connector_wrapped,
]
...
class H3Agent(BaseAgent):
    ...
    def _make_compiled_graph(self):
        self.response = None
        return make_h3_tableau_agent(**self._params)
