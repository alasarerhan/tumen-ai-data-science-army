...
def evaluate_calibration_wrapped(y_true: Sequence[int], y_prob: Sequence[float], n_bins: int) -> Tuple[str, dict]:
...
@tool(response_format="content_and_artifact")
def evaluate_segments_wrapped(df: pd.DataFrame, y_true: Sequence[int], y_pred: Sequence[int], segment_columns: Sequence[str]) -> Tuple[str, dict]:
