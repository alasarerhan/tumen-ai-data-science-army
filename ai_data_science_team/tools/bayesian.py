...
from math import lgamma  # noqa: E402, F401
from typing import Any, Dict, Sequence, Tuple  # noqa: E402, F401
...
class BetaPosterior:
    ...
    def credible_interval(self, mass: float = 0.95) -> Tuple[float, float]:
        ...
        from scipy.stats import beta as beta_dist  # noqa: E402, F401
