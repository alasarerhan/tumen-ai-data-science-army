"""Tests for ``ai_data_science_team.tools.e3_deep_learning`` (E3 tool layer).

Implementation note
-------------------
The test module deliberately imports the package *once* at module
level via ``import ai_data_science_team.tools.e3_deep_learning as
...
import ai_data_science_team.tools.e3_deep_learning as e3  # noqa: E402
