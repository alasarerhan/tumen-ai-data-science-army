...
## Workflow
1. Ask once whether the user wants a stack-aware security check plan, following `../codex-sentinel/references/interaction-model.md` for language behavior when available.
