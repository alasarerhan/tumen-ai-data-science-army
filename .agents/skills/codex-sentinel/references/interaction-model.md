...
- Prefer the user's configured Codex language for user-facing replies when available.
...
- When a stage skill needs a yes-or-no offer, ask once in the user's configured Codex language when available.
- If that signal is unavailable, follow the active conversation language.
