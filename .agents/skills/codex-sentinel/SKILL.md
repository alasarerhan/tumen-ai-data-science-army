...
4. For `plan`, invoke `../security-plan-gap/SKILL.md` automatically.
...
8. For `review`, ask once before invoking `../security-review-gate/SKILL.md`. If the user accepts, treat that acceptance as consent for read-only active analysis within the current review scope.
9. For `test-rig`, ask once before invoking `../security-test-rig/SKILL.md`.
