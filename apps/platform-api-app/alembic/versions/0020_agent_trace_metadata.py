...
def upgrade() -> None:
    ...
    op.add_column("agent_execution_traces", sa.Column("cost_summary_json", sa.Text(), nullable=True))
    op.add_column("agent_execution_traces", sa.Column("evaluation_summary_json", sa.Text(), nullable=True))
    op.add_column("agent_execution_traces", sa.Column("version_metadata_json", sa.Text(), nullable=True))
