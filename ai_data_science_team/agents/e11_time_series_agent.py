...
tool layer (``ai_data_science_team.tools.e11_time_series``) with
LangChain ``@tool`` decorators and exposes the standard
``make_e11_time_series_agent`` factory + ``E11Agent`` OO
...
import pandas as pd
from typing import List, Dict, Sequence, Mapping, Iterable

from ai_data_science_team.tools.e11_time_series import (
    build_panel,
    holiday_calendar,
...
E11_TOOLS = [
    e11_seasonal_naive_forecast_wrapped,
    e11_moving_average_forecast_wrapped,
    e11_multiplicative_seasonal_forecast_wrapped,
    e11_reconcile_top_down_wrapped,
    e11_holiday_calendar_wrapped,
    e11_build_panel_wrapped,
]
...
def make_e11_time_series_agent(
    model: Any,
...
class E11Agent(BaseAgent):
    ...
    def _make_compiled_graph(self):
        self.response = None
        return make_e11_time_series_agent(**self._params)
