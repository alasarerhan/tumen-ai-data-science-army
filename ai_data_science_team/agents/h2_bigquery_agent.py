...
tool layer (``ai_data_science_team.tools.h2_bigquery``) with
LangChain ``@tool`` decorators and exposes the standard
``make_h2_bigquery_agent`` factory + ``H2Agent`` OO
...
from ai_data_science_team.tools.h2_bigquery import (
    BigQueryConnector,
...
H2_TOOLS = [
    h2_build_bigquery_connector_wrapped,
]
...
class H2Agent(BaseAgent):
    ...
    def _make_compiled_graph(self):
        self.response = None
        return make_h2_bigquery_agent(**self._params)
