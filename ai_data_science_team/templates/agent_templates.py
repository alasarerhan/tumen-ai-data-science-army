...
class BaseAgent(CompiledStateGraph):
    ...
    def get_workflow_summary(self, markdown: bool = False) -> Optional[str]:
        ...
        if self.response and self.response.get("messages"):
            try:
                from ai_data_science_team.utils.regex import get_generic_summary
...
def create_react_agent_graph(
    ...
    ::
        ...
        from ai_data_science_team.templates import create_react_agent_graph
        from ai_data_science_team.tool_registry import ToolRegistry

        # Tools must be registered first
        from ai_data_science_team.tools.anomaly import *
